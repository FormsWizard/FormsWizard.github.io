...
export default function TeamMemberGalery() {
    return (
        <div class="page-main text-[#5660ce]">
            ...
            <div class="wrap-element-a">
                ...
                <div>
                    ...
                    <p class="leading-relaxed text-center md:text-left">has worked on many projects that use Javascript, different Frameworks and the Web. has a weakness for tidy looking code and succulent food.</p>
                </div>
            </div>
